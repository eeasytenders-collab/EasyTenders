    ...
    <SafeAreaView className="flex-1" style={{ backgroundColor: bgColor }}>
      ...
      >
        ...
        >
          ...
          {/* Spacer to push the CTA to bottom and keep it visible above keyboard */}
          <View className="flex-1" />

          {/* Confirm Button */}
          <TouchableOpacity
            className="w-full rounded-lg py-3 items-center mb-3"
          ...
          {/* Timer */}
          <Text className="text-center text-lg font-semibold mb-4" style={{ color: buttonBg }}>
